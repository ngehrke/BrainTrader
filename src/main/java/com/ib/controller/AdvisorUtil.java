...
public class AdvisorUtil {
	static List<com.ib.controller.Group> getGroups(String xml) {
		try {
	...
	static List<com.ib.controller.Group> getGroups_(String xml) throws IOException {
		List<com.ib.controller.Group> list = new ArrayList<>();

		com.ib.controller.Group group = null;
		com.ib.controller.Account account = null;
			...
			switch( state) {
				...
				case 1:
					if (line.equals( "<Group>")) {
						group = new com.ib.controller.Group();
						state = 2;
					}
				...
				case 3:
					if (line.equals( "</ListOfAccts>")) {
						...
						account = new com.ib.controller.Account();
						state = 4;
					}
					else {
						err( line);
	...
	static List<com.ib.controller.Alias> getAliases(String xml) {
		try {
	...
	static List<com.ib.controller.Alias> getAliases_(String xml) throws IOException {
		List<com.ib.controller.Alias> list = new ArrayList<>();

		com.ib.controller.Alias alias = null;
			...
			switch( state) {
				...
				case 1:
					if (line.equals( "<AccountAlias>")) {
						alias = new com.ib.controller.Alias();
						state = 2;
					}
	...
	public static String getGroupsXml(List<com.ib.controller.Group> groups) {
