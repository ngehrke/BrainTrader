...
public class Order {
    ...
    public boolean equals(Object p_other) {
        ...
        if (com.ib.client.Util.StringCompare(m_action, l_theOther.m_action) != 0
            || com.ib.client.Util.StringCompare(m_orderType, l_theOther.m_orderType) != 0
        	|| com.ib.client.Util.StringCompare(m_tif, l_theOther.m_tif) != 0
        	|| com.ib.client.Util.StringCompare(m_activeStartTime, l_theOther.m_activeStartTime) != 0
        	|| com.ib.client.Util.StringCompare(m_activeStopTime, l_theOther.m_activeStopTime) != 0
        	|| com.ib.client.Util.StringCompare(m_ocaGroup, l_theOther.m_ocaGroup) != 0
        	|| com.ib.client.Util.StringCompare(m_orderRef,l_theOther.m_orderRef) != 0
        	|| com.ib.client.Util.StringCompare(m_goodAfterTime, l_theOther.m_goodAfterTime) != 0
        	|| com.ib.client.Util.StringCompare(m_goodTillDate, l_theOther.m_goodTillDate) != 0
        	|| com.ib.client.Util.StringCompare(m_rule80A, l_theOther.m_rule80A) != 0
        	|| com.ib.client.Util.StringCompare(m_faGroup, l_theOther.m_faGroup) != 0
        	|| com.ib.client.Util.StringCompare(m_faMethod, l_theOther.m_faMethod) != 0
        	|| com.ib.client.Util.StringCompare(m_faPercentage, l_theOther.m_faPercentage) != 0
        	|| com.ib.client.Util.StringCompare(m_openClose, l_theOther.m_openClose) != 0
        	|| com.ib.client.Util.StringCompare(m_designatedLocation, l_theOther.m_designatedLocation) != 0
        	|| com.ib.client.Util.StringCompare(m_deltaNeutralOrderType, l_theOther.m_deltaNeutralOrderType) != 0
        	|| com.ib.client.Util.StringCompare(m_deltaNeutralSettlingFirm, l_theOther.m_deltaNeutralSettlingFirm) != 0
        	|| com.ib.client.Util.StringCompare(m_deltaNeutralClearingAccount, l_theOther.m_deltaNeutralClearingAccount) != 0
        	|| com.ib.client.Util.StringCompare(m_deltaNeutralClearingIntent, l_theOther.m_deltaNeutralClearingIntent) != 0
        	|| com.ib.client.Util.StringCompare(m_deltaNeutralOpenClose, l_theOther.m_deltaNeutralOpenClose) != 0
        	|| com.ib.client.Util.StringCompare(m_deltaNeutralDesignatedLocation, l_theOther.m_deltaNeutralDesignatedLocation) != 0
        	|| com.ib.client.Util.StringCompare(m_hedgeType, l_theOther.m_hedgeType) != 0
        	|| com.ib.client.Util.StringCompare(m_hedgeParam, l_theOther.m_hedgeParam) != 0
        	|| com.ib.client.Util.StringCompare(m_account, l_theOther.m_account) != 0
        	|| com.ib.client.Util.StringCompare(m_settlingFirm, l_theOther.m_settlingFirm) != 0
        	|| com.ib.client.Util.StringCompare(m_clearingAccount, l_theOther.m_clearingAccount) != 0
        	|| com.ib.client.Util.StringCompare(m_clearingIntent, l_theOther.m_clearingIntent) != 0
        	|| com.ib.client.Util.StringCompare(m_algoStrategy, l_theOther.m_algoStrategy) != 0
        	|| com.ib.client.Util.StringCompare(m_algoId, l_theOther.m_algoId) != 0
        	|| com.ib.client.Util.StringCompare(m_scaleTable, l_theOther.m_scaleTable) != 0
        	|| com.ib.client.Util.StringCompare(m_modelCode, l_theOther.m_modelCode) != 0
        	|| com.ib.client.Util.StringCompare(m_referenceExchangeId, l_theOther.m_referenceExchangeId) != 0
        	|| com.ib.client.Util.StringCompare(m_extOperator, l_theOther.m_extOperator) != 0
        	|| com.ib.client.Util.StringCompare(m_mifid2DecisionMaker, l_theOther.m_mifid2DecisionMaker) != 0
            || com.ib.client.Util.StringCompare(m_mifid2DecisionAlgo, l_theOther.m_mifid2DecisionAlgo) != 0
            || com.ib.client.Util.StringCompare(m_mifid2ExecutionTrader, l_theOther.m_mifid2ExecutionTrader) != 0
            || com.ib.client.Util.StringCompare(m_mifid2ExecutionAlgo, l_theOther.m_mifid2ExecutionAlgo) != 0
            || com.ib.client.Util.StringCompare(m_autoCancelDate, l_theOther.m_autoCancelDate) != 0
            || com.ib.client.Util.StringCompare(m_shareholder, l_theOther.m_shareholder) != 0
            || com.ib.client.Util.StringCompare(m_advancedErrorOverride, l_theOther.m_advancedErrorOverride) != 0
            || com.ib.client.Util.StringCompare(m_manualOrderTime, l_theOther.m_manualOrderTime) != 0
            || com.ib.client.Util.StringCompare(m_customerAccount, l_theOther.m_customerAccount) != 0
            || com.ib.client.Util.StringCompare(m_bondAccruedInterest, l_theOther.m_bondAccruedInterest) != 0
            || com.ib.client.Util.StringCompare(m_externalUserId, l_theOther.m_externalUserId) != 0
            ) {
        	return false;
        }

        if (!com.ib.client.Util.listsEqualUnordered(m_algoParams, l_theOther.m_algoParams)) {
        	return false;
        }

        if (!com.ib.client.Util.listsEqualUnordered(m_smartComboRoutingParams, l_theOther.m_smartComboRoutingParams)) {
        	return false;
        }

    	// compare order combo legs
        if (!com.ib.client.Util.listsEqualUnordered(m_orderComboLegs, l_theOther.m_orderComboLegs)) {
        	return false;
        }
