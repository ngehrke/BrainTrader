...
public class Execution {
    ...
    private com.ib.client.Decimal m_shares;
    private double 	m_price;
    private int		m_permId;
    private int     m_liquidation;
    private com.ib.client.Decimal m_cumQty;
    ...
    public void shares(com.ib.client.Decimal shares)            { m_shares = shares; }
    ...
    public void cumQty(com.ib.client.Decimal cumQty)            { m_cumQty = cumQty; }
    ...
    public Execution() {
        m_orderId = 0;
        m_clientId = 0;
        m_shares = com.ib.client.Decimal.ZERO;
        m_price = 0;
        m_permId = 0;
        m_liquidation = 0;
        m_cumQty = com.ib.client.Decimal.ZERO;
        m_avgPrice = 0;
        m_evMultiplier = 0;
    ...
    public Execution( int p_orderId, int p_clientId, String p_execId, String p_time,
                      String p_acctNumber, String p_exchange, String p_side, com.ib.client.Decimal p_shares,
