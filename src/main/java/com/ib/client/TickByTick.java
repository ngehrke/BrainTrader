...
public class TickByTick {
    ...
    private com.ib.client.Decimal m_size;
    ...
    private com.ib.client.Decimal m_bidSize;
    private double m_askPrice;
    private com.ib.client.Decimal m_askSize;
    private double m_midPoint;

    public TickByTick(int tickType, long time, double price, com.ib.client.Decimal size, TickAttribLast tickAttribLast, String exchange, String specialConditions) {
    	m_tickType = tickType;
        m_time = time;
        m_price = price;
        m_size = size;
    ...
    public TickByTick(long time, double bidPrice, com.ib.client.Decimal bidSize, double askPrice, com.ib.client.Decimal askSize, TickAttribBidAsk tickAttribBidAsk) {
    	m_tickType = 3;
        m_time = time;
        m_bidPrice = bidPrice;
        m_bidSize = bidSize;
    ...
    public com.ib.client.Decimal size() {
        return m_size;
    }
    ...
    public com.ib.client.Decimal bidSize() {
        return m_bidSize;
    }
