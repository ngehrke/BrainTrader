...
public class ContractDetails {
    ...
    private List<com.ib.client.TagValue> m_secIdList; // CUSIP/ISIN/etc.
    ...
    private com.ib.client.Decimal m_minSize;
    private com.ib.client.Decimal m_sizeIncrement;
    private com.ib.client.Decimal m_suggestedSizeIncrement;
    ...
    public com.ib.client.Contract contract()          { return m_contract; }
    ...
    public List<com.ib.client.TagValue> secIdList()   { return m_secIdList; }
    ...
    public com.ib.client.Decimal minSize()            { return m_minSize; }
    public com.ib.client.Decimal sizeIncrement()      { return m_sizeIncrement; }
    public com.ib.client.Decimal suggestedSizeIncrement() { return m_suggestedSizeIncrement; }
    ...
    // Set
    public void contract(com.ib.client.Contract contract)         { m_contract = contract; }
    ...
    public void minSize(com.ib.client.Decimal minSize)            { m_minSize = minSize; }
    public void sizeIncrement(com.ib.client.Decimal sizeIncrement) { m_sizeIncrement = sizeIncrement; }
