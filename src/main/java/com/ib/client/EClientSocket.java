...
public class EClientSocket extends EClient implements EClientMsgSink  {
	...
	@Override
	protected com.ib.client.Builder prepareBuffer() {
        com.ib.client.Builder buf = new com.ib.client.Builder( 1024 );
        if( m_useV100Plus ) {
	...
	@Override
	protected void closeAndSend(com.ib.client.Builder buf) throws IOException {
    	if( m_useV100Plus ) {
    		buf.updateLength( 0 ); // New buffer means length header position is always zero
    	}
    	
    	com.ib.client.EMessage msg = new EMessage(buf);
	...
	protected synchronized void eConnect(Socket socket) throws IOException {
	    ...
	    // start reader thread
	    com.ib.client.EReader reader = new EReader(this, m_signal);
	...
	public synchronized void eConnect( String host, int port, int clientId, boolean extraAuth) {
        try {
            ...
            error(com.ib.client.EClientErrors.NO_VALID_ID, e.error(), e.text());
            return;
        }
	...
	public synchronized void redirect(String newAddress) {
	    if( m_useV100Plus ) {
	    	if (!m_allowRedirect) {
	    		m_eWrapper.error(com.ib.client.EClientErrors.NO_VALID_ID, com.ib.client.EClientErrors.CONNECT_FAIL.code(), com.ib.client.EClientErrors.CONNECT_FAIL.msg(), null);
	    		return;
	    	}
	...
	public synchronized void serverVersion(int version, String time) {
		...
		if( m_useV100Plus && (m_serverVersion < MIN_VERSION || m_serverVersion > MAX_VERSION) ) {
			eDisconnect();
			m_eWrapper.error(com.ib.client.EClientErrors.NO_VALID_ID, com.ib.client.EClientErrors.UNSUPPORTED_VERSION.code(), com.ib.client.EClientErrors.UNSUPPORTED_VERSION.msg(), null);
			return;
		}
		
	    if( m_serverVersion < MIN_SERVER_VER_SUPPORTED) {
	    	eDisconnect();
	        m_eWrapper.error( com.ib.client.EClientErrors.NO_VALID_ID, com.ib.client.EClientErrors.UPDATE_TWS.code(), EClientErrors.UPDATE_TWS.msg(), null);
	        return;
	    }
