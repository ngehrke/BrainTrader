...
public class Contract implements Cloneable {
    ...
    private List<com.ib.client.ComboLeg> m_comboLegs = new ArrayList<>(); // would be final except for clone
    ...
    public List<com.ib.client.ComboLeg> comboLegs()  { return m_comboLegs; }
    ...
    public void comboLegs(List<com.ib.client.ComboLeg> v)  { m_comboLegs = v; }
    ...
    public Contract(int p_conId, String p_symbol, String p_secType, String p_lastTradeDateOrContractMonth, String p_lastTradeDate,
                    ...
                    List<com.ib.client.ComboLeg> p_comboLegs, String p_primaryExch, boolean p_includeExpired,
    ...
    public boolean equals(Object p_other) {
        ...
        if (com.ib.client.Util.StringCompare(m_secType, l_theOther.m_secType) != 0) {
        	return false;
        }

        if (com.ib.client.Util.StringCompare(m_symbol, l_theOther.m_symbol) != 0 ||
        	com.ib.client.Util.StringCompare(m_exchange, l_theOther.m_exchange) != 0 ||
        	com.ib.client.Util.StringCompare(m_primaryExch, l_theOther.m_primaryExch) != 0 ||
        	com.ib.client.Util.StringCompare(m_currency, l_theOther.m_currency) != 0) {
        	return false;
        }
        ...
        if (!"BOND".equals(m_secType)) {
        	...
        	if (com.ib.client.Util.StringCompare(m_lastTradeDateOrContractMonth, l_theOther.m_lastTradeDateOrContractMonth) != 0 ||
        		com.ib.client.Util.StringCompare(m_lastTradeDate, l_theOther.m_lastTradeDate) != 0 ||
        		com.ib.client.Util.StringCompare(m_right, l_theOther.m_right) != 0 ||
        		com.ib.client.Util.StringCompare(m_multiplier, l_theOther.m_multiplier) != 0 ||
        		com.ib.client.Util.StringCompare(m_localSymbol, l_theOther.m_localSymbol) != 0 ||
        		com.ib.client.Util.StringCompare(m_tradingClass, l_theOther.m_tradingClass) != 0) {
        		return false;
        	}
        }

        if (com.ib.client.Util.StringCompare(m_secIdType, l_theOther.m_secIdType) != 0) {
        	return false;
        }

        if (com.ib.client.Util.StringCompare(m_secId, l_theOther.m_secId) != 0) {
        	return false;
        }

    	// compare combo legs
        if (!com.ib.client.Util.listsEqualUnordered(m_comboLegs, l_theOther.m_comboLegs)) {
        	return false;
        }
        ...
        if (com.ib.client.Util.StringCompare(m_description, l_theOther.m_description) != 0) {
        	return false;
        }
        if (com.ib.client.Util.StringCompare(m_issuerId, l_theOther.m_issuerId) != 0) {
        	return false;
        }
