...
public class HistogramEntry implements Comparable<HistogramEntry> {
    ...
    private com.ib.client.Decimal size;
	...
	public void size(com.ib.client.Decimal size) {
		this.size = size;
	}

	public HistogramEntry(double price, com.ib.client.Decimal size) {
        this.price = price;
        this.size = size;
    }
    ...
    public boolean equals(Object o) {
        ...
        return Double.compare(price, he.price) == 0 && com.ib.client.Decimal.compare(size, he.size) == 0;
    }
