...
public interface EWrapper {
    ...
    void tickSize( int tickerId, int field, com.ib.client.Decimal size);
    ...
    void orderStatus(int orderId, String status, com.ib.client.Decimal filled, com.ib.client.Decimal remaining,
                     double avgFillPrice, int permId, int parentId, double lastFillPrice,
                     int clientId, String whyHeld, double mktCapPrice);
    void openOrder(int orderId, com.ib.client.Contract contract, com.ib.client.Order order, OrderState orderState);
    void openOrderEnd();
    void updateAccountValue(String key, String value, String currency, String accountName);
    void updatePortfolio(com.ib.client.Contract contract, com.ib.client.Decimal position, double marketPrice, double marketValue,
    ...
    void execDetails(int reqId, com.ib.client.Contract contract, Execution execution);
    void execDetailsEnd( int reqId);
    void updateMktDepth( int tickerId, int position, int operation, int side, double price, com.ib.client.Decimal size);
    void updateMktDepthL2(int tickerId, int position, String marketMaker, int operation,
                          int side, double price, com.ib.client.Decimal size, boolean isSmartDepth);
    ...
    void historicalData(int reqId, com.ib.client.Bar bar);
    void scannerParameters(String xml);
    void scannerData(int reqId, int rank, ContractDetails contractDetails, String distance,
    		String benchmark, String projection, String legsStr);
    void scannerDataEnd(int reqId);
    void realtimeBar(int reqId, long time, double open, double high, double low, double close, com.ib.client.Decimal volume, com.ib.client.Decimal wap, int count);
    ...
    void position(String account, com.ib.client.Contract contract, com.ib.client.Decimal pos, double avgCost);
    void positionEnd();
    ...
    void connectAck();
    void positionMulti(int reqId, String account, String modelCode, com.ib.client.Contract contract, com.ib.client.Decimal pos, double avgCost);
	...
	void pnlSingle(int reqId, com.ib.client.Decimal pos, double dailyPnL, double unrealizedPnL, double realizedPnL, double value);
    ...
    void tickByTickAllLast(int reqId, int tickType, long time, double price, com.ib.client.Decimal size, TickAttribLast tickAttribLast, String exchange, String specialConditions);
    void tickByTickBidAsk(int reqId, long time, double bidPrice, double askPrice, com.ib.client.Decimal bidSize, Decimal askSize, TickAttribBidAsk tickAttribBidAsk);
