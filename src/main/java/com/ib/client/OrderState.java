...
public class OrderState {
    ...
    public boolean equals(Object other) {
        ...
        if (com.ib.client.Util.StringCompare(m_status, state.m_status) != 0 ||
            com.ib.client.Util.StringCompare(m_initMarginBefore, state.m_initMarginBefore) != 0 ||
            com.ib.client.Util.StringCompare(m_maintMarginBefore, state.m_maintMarginBefore) != 0 ||
            com.ib.client.Util.StringCompare(m_equityWithLoanBefore, state.m_equityWithLoanBefore) != 0 ||
            com.ib.client.Util.StringCompare(m_initMarginChange, state.m_initMarginChange) != 0 ||
            com.ib.client.Util.StringCompare(m_maintMarginChange, state.m_maintMarginChange) != 0 ||
            com.ib.client.Util.StringCompare(m_equityWithLoanChange, state.m_equityWithLoanChange) != 0 ||
            com.ib.client.Util.StringCompare(m_initMarginAfter, state.m_initMarginAfter) != 0 ||
            com.ib.client.Util.StringCompare(m_maintMarginAfter, state.m_maintMarginAfter) != 0 ||
            com.ib.client.Util.StringCompare(m_equityWithLoanAfter, state.m_equityWithLoanAfter) != 0 ||
        	com.ib.client.Util.StringCompare(m_commissionCurrency, state.m_commissionCurrency) != 0 ||
